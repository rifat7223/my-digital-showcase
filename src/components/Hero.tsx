            ...
            >
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-secondary/80 transition-all duration-300 hover:scale-110"
