      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="bg-card rounded-2xl p-6 md:p-8 border border-border shadow-card">
              <h3 className="font-display text-xl font-bold mb-4">Let's Work Together</h3>
          ...
          >
            <form
              ...
              className="bg-card rounded-2xl p-6 md:p-8 border border-border shadow-card space-y-6"
            >
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full h-12 px-4 rounded-xl bg-secondary border border-border focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
